...
{
    float px = pivC - texture3D( u_img3_vol, texCd + u_texCdOfst.xww).x+ 0.001;
    float py = pivC - texture3D( u_img3_vol, texCd + u_texCdOfst.wxw).x;
    float pz = pivC - texture3D( u_img3_vol, texCd + u_texCdOfst.wwx).x;
